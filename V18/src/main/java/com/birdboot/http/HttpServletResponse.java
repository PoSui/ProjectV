...
public class HttpServletResponse {
    ...
    private static MimetypesFileTypeMap mtft = new MimetypesFileTypeMap();
    //响应行相关信息
...
//        println("Content-Length: "+contentFile.length());
    ...
    public void setContentFile(File contentFile) {
        ...
        this.addHeaders("Content-Type",mtft.getContentType(contentFile));
        this.addHeaders("Content-Length",String.valueOf(contentFile.length()));
    }
